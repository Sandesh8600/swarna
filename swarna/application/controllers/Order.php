...
class Order extends CI_Controller {
	...
	public function browse(){
			...
			$result=$this->Order_model->get_users($page_start,$page_size,$order_type);
			...
			$this->lib->render_view("modules/order/browse.php",$data);
    ...
    public function edit($user_id){
			...
			if($this->form_validation->run()){
				...
				$this->lib->render_view("modules/order/edit.php",$data);
	...
	{
		$this->lib->render_view("modules/order/create.php");
