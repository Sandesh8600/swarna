...
<div class="form-div">
	...
	<form action="<?php echo site_url("stones/browse?create_form=yes"); ?>" method='POST' enctype="multipart/form-data" name="create_form" id="create-form-id">
		
		<div class="form-block">
			<div class="form-row">
				<div class="form-column">
					<label class="radio-label">Stone Type Name</label>
					<input type="text" class="form-input" name="name" placeholder="Name" value="<?php echo set_value('name'); ?>" minlength='3' maxlength='50' required/>
				</div>
				<div class="clear"></div>
			</div>
