...
<div class="form-div">
	...
	<form action="<?php echo site_url("items/create"); ?>" method='POST' enctype="multipart/form-data" name="create_form" id="create-form-id">
		
		<div class="form-block">
			<div class="form-row">
				<div class="form-column">
					<label class="radio-label">Item Name</label>
					<input type="text" class="form-input" name="full_name" placeholder="Item Name" value="<?php echo set_value('full_name'); ?>" minlength='1' maxlength='50' required/>
				</div>
				<div class="clear"></div>
			</div>
