...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Gold Transactions for Jewellery</h1>
          </div>
...
<div id='create-form'>
<!-- <h1 class='h1-title'>Gold Transactions for Jewellery</h1> -->
<div class="form-div">
	
	<div class="validation-errors"><?php echo validation_errors(); ?></div>
	<form action="<?php echo site_url("jewellary/create"); ?>" method='POST' enctype="multipart/form-data" name="create_form" id="create-form-id">
		
	  <div class="form-block">
	  <input type="hidden" name="entity_type" value="Jewellary">
			...
			<!-- <div class="form-row">
				<div class="form-column">
					...
					<input type="text" class="form-input" name="from_entity" placeholder="From Entity Type" value="<?php echo set_value('from_entity'); ?>" minlength='1' maxlength='50'/>
				</div>
				
				<div class="form-column">
					<label class="radio-label">From Entity ID</label>
					<input type="text" class="form-input" name="from_entity_id" placeholder="From Entity ID" minlength='1' maxlength='400' value="<?php echo set_value('from_entity_id'); ?>" />
				</div>
				<div class="clear"></div>
			</div> -->
