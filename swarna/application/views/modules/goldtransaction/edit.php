...
<div id='edit-form'>
<h1 class='h1-title'>Edit Gold Transactions for workshop ID #<?php echo $this->session->userdata('workshop_id');?></h1>
<div class="form-div">
	
	<div class="validation-errors"><?php echo validation_errors(); ?></div>
	<form action="<?php echo site_url("goldtransaction/edit/".$user['Transaction_ID']); ?>" method='POST' enctype="multipart/form-data" name="edit_form" id="edit-form-id">
