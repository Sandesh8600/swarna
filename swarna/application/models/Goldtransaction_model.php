<?php
    class Goldtransaction_model extends CI_Model{
      ...
      */
      public function get_users($page_start,$page_size){
        ...
        //build query
        $query=$this->db->query("select u.* from gold_transaction u where u.Entity_Id=".$this->session->userdata('workshop_id')." and u.Entity_Type='Workshop' and 1 ".$where.$sort_query." limit ?,?",$params);
